...
<body>
    ...
    <header>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                ...
                <button class="nav-link active" onclick="location.href = '/api/mail/sentMailbox';" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-selected="false">Wysłane</button>
    ...
    <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="container">
                    <h2 class="secondary-header-class">Skrzynka nadawcza</h2>
                    <div class="list-group">
                    <% for(Wiadomosci w : (List<Wiadomosci>)request.getAttribute("listOfSentMails")){
                    %>
                       <a class="list-group-item list-group-item-action" href="/api/mail/readMail?idWiadomosci=<%=w.getIdWiadomosci()%>">Wiadomość do: <b><%=w.getDoKogo()%></b> Temat: <%=w.getTemat()%></a><br>
                    <% } %>
                    </div>
                </div>
            </div>
